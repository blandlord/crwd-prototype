...
class Order extends Component {
  ...
  cancelOrder(orderId){
    this.props.crowdOwnedExchangeActions.cancelOrder({orderId:orderId, crowdOwnedAddress: this.props.crowdOwnedAddress});
  }
  ...
  render() {
    let {order, web3Store,crowdOwnedExchangeStore} = this.props;
